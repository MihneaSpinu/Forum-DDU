<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
  ...
  <form class="form-inline my-lg-0 d-lg-none mx-auto">
      <input class="form-control" type="search" placeholder="Search" aria-label="Search">
  </form>
  <div class="collapse navbar-collapse justify-content-center mx-5" id="navbarTogglerDemo03">
    ...
    <form class="position-absolute form-inline my-2 my-lg-0 d-none d-lg-block">
      <input class="form-control" type="search" placeholder="Search" aria-label="Search">
    </form>
